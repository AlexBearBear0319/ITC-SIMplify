 ...
 * Admin Panel — /admin
 *
 * Only accessible to users with is_admin = true in profiles.
 * Unauthorized users are redirected to /.
 *
 * Supabase wiring (when DB functions are ready):
...
// ─────────────────────────────────────────────
// Mock data  ← swap with Supabase RPCs when DB functions are ready
// ─────────────────────────────────────────────
