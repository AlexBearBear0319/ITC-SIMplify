      ...
      */}
      ...
      >
        ...
        <div className="px-4 py-3 border-t border-border dark:border-slate-700 shrink-0">
          ...
          >
            <div className="w-9 h-9 rounded-full bg-brand-light flex items-center justify-center text-sm font-bold text-ink shrink-0 group-hover:ring-2 group-hover:ring-brand transition-all duration-200">
              S
            </div>
