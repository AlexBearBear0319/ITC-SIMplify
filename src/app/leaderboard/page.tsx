 ...
 *
 * Fetches profiles ordered by points_balance desc, limited to top 50.
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-ink-muted">
                {me.points_balance.toLocaleString()} pts — keep checking in to climb!
              </p>
            </div>
            <span className="text-xl shrink-0">
              {getLevelEmoji(me.points_balance)}
            </span>
          </motion.div>
        )}
        ...
        <section>
          ...
          >
            {rest.map((entry, i) => {
              ...
              const levelEmoji   = getLevelEmoji(entry.points_balance);
              ...
              return (
                ...
                >
                  ...
                  <div className="shrink-0 flex items-center gap-1 font-bold text-gold text-sm">
                    <Coins size={13} />
                    <span>{entry.points_balance.toLocaleString()}</span>
                  </div>
                </motion.div>
              );
            })}
